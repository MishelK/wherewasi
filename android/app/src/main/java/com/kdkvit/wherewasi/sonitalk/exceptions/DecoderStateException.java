...
/**
 * Exception thrown when trying to e.g. start the SoniTalkDecoder while it is in a state that does
 * not allow it.
 */
public class DecoderStateException extends SoniTalkException {
     ...
     */
    public DecoderStateException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public DecoderStateException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public DecoderStateException(Throwable cause) {
        super(cause);
    }
}
