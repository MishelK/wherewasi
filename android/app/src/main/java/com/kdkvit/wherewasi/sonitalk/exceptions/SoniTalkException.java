...
public class SoniTalkException extends Exception {
     ...
     */
    public SoniTalkException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public SoniTalkException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public SoniTalkException(Throwable cause) {
        super(cause);
    }
    ...
    public SoniTalkException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
